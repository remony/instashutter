...
public class PicModel {
    		...
    		for (Row row : rs) {
    	    	...
    	    	if (rss.isExhausted())	{
    	    		...
    	    		for (Row rows : rss)	{
    	    			...
    	    			pic.bindCommentToPost(username2, date2, comment2);
    	    		}
    	    	}
    		}
    		session.close();
    ...
    public static LinkedList<CommentStore> getPostComments(UUID picid) {
    	    	...
    	    	if (rss.isExhausted())	{
    	    		...
    	    		for (Row rows : rss)	{
    	    			...
    	    			commentS.setUuid(uuid);
    						...
    						commentS.setCommentMessage(comment2);
  	    				comments.add(commentS);
    	    			ps.bindCommentToPost(username2, date2, comment2);
    	    		}
    	    	}
    		}
    	}
